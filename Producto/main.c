...
void mostrarArrayProductosConProveedoresElMaximo(ePeoducto[],int,eProveedor[],int);
void mostrarArrayConProductosOrdenados(eProducto[],eProveedor[],int,int Deac);
...
int main()
{
    ...
    inicializarProveedor(listadoProductos,T);
